...
//this function implements a Postfix (Reverse Polish Notation) calculator using a stack
//reads tokes from a space-separated string
//if it's a number, it pushes it to the stack
//if it's an operator (+,-,*,/), it pops the top two numbers from the stack, 
